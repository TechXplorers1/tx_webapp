...
const CustomNavbar = () => {
  ...
  const handleDashboardClick = () => {
    ...
    navigate('/clientdashboard', { replace: false });
  };
      ...
      <Container fluid>
        ...
        <Navbar.Collapse id="basic-navbar-nav">
          ...
          <div className="d-flex align-items-center gap-3">
            ...
            {isLoggedIn ? (
              <div className="position-relative profile-icon-wrapper">
                <Image
                  src={profileIcon}
                  alt="Profile"
                  roundedCircle
                ...
                {showProfileDropdown && (
                  ...
                  >
                    <Link to="/clientdashboard" className="dropdown-item" onClick={handleDashboardClick}>
                      Dashboard
                    </Link>
                    <Dropdown.Divider />
