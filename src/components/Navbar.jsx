...
const CustomNavbar = () => {
  // Step 2: Get auth state and functions from the context
  ...
  // --- Handlers for the Services Dropdown ---
  ...
  // --- Handlers for the Profile Dropdown ---
      ...
      <Container fluid>
        ...
        <Navbar.Collapse id="basic-navbar-nav">
          ...
          <div className="d-flex align-items-center gap-3">
            ...
            {/* Step 4: Conditional rendering based on context */}
            {isLoggedIn ? (
              <div className="position-relative">
                <img
                  src={user?.avatar || 'https://placehold.co/40x40/6c757d/white?text=P'} // Use user's avatar with a fallback
                  alt="Profile"
