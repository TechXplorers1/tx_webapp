...
import '../../styles/services/JobSupportContactForm.css';
  ...
  return (
    <div style={{ backgroundColor: 'transparent', padding: '10px' }}>
      ...
      <Container className="my-1 contact-form">
        ...
        <h1 className="text-center p-3" style={{ fontFamily: "Orbitron" }}>BOOK A SERVICE WITH TECHXPLORERS</h1>
        ...
        <Form onSubmit={handleSubmit} className="mx-auto" style={{ maxWidth: '800px' }}>
          ...
          <div className="d-grid mt-4 p-3">
            <Button
              ...
              style={{  borderColor: '#00ffff', color: '#000' }}
