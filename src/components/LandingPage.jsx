...
const LandingPage = () => {
  ...
  const activeServices = useMemo(() => {
    ...
    const services = Object.values(user.serviceRegistrations).map(reg => 
      reg.service.trim().toLowerCase() // Standardize to lowercase and remove spaces
    );
    
    // DEBUG: Check what services are being loaded for the user
    console.log('Loaded Active Services:', services); 
                      ...
                      <Col lg={6} className="hero-carousel-text">
                        ...
                        <div className="hero-carousel-buttons">
                          {(() => {
                            ...
                            console.log('Checking Carousel Service:', `"${serviceToCheck}"`);
